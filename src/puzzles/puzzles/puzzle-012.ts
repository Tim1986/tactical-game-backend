...
/**
 * Puzzle #12 — "Reel and Finish" (PULL — the oldest family, no camouflage).
 *
 ...
 *
 * #7 puts this same idea behind a loadout choice; this one states it plainly,
 ...
 */
export const PUZZLE_012: PuzzleDefinition = {
  id: 'puzzle-012',
  title: 'Puzzle #12 — Reel and Finish',
  ...
  units: [
    {
      ...
      // doc names as the tell every post-puzzle-901 puzzle reintroduced. Now the player
