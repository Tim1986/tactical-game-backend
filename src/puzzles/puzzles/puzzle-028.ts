...
/**
 * Puzzle #28 — "Keep the Flame" (TEMPO — an ally heals the target).
 *
 * #25's channel with the finish moved to a line ability. The enemy Cleric acts
...
export const PUZZLE_028: PuzzleDefinition = {
  id: 'puzzle-028',
  title: 'Puzzle #28 — Keep the Flame',
