...
/**
 * Puzzle #5 — "Through and Through" (v2 texture: FRIENDLY FIRE / the line
 ...
 * first move deals LESS damage to the goal target than the alternative — #33's
 ...
 */
export const PUZZLE_005: PuzzleDefinition = {
  id: 'puzzle-005',
  title: 'Puzzle #5 — Through and Through',
