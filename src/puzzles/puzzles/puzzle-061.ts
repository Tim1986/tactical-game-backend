...
/**
 * Puzzle #61 — "Pay the Fate" (THREE TURNS, Tier-1).
 *
 * ⚠ DELIBERATE SPACED NEAR-CLONE of #53 (re-dressing licence, recorded with
 * #54). Same bones — one wide roll at the head of the queue, and an unblockable
 ...
 * free and the arithmetic collapses — the #56 lesson, from the enemy's side.
 *
 * Vocabulary 2. Tier-1 fate.
 */
export const PUZZLE_061: PuzzleDefinition = {
  id: 'puzzle-061',
  title: 'Puzzle #61 — Pay the Fate',
