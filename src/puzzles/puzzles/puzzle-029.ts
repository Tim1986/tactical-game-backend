 ...
 * the Barbarian lives to swing a Whirlwind worth 20.
 *
 ...
 *
 * Slack: 10 + 20 against 28. Vocabulary 2. Tier-0 fate. 2v1.
 */
export const PUZZLE_029: PuzzleDefinition = {
  ...
  units: [
    ...
    { id: 'targ', side: 'enemy', slug: 'warlock', specialSlug: 'drain', position: { x: 5, y: 4 }, currentHealth: 28 },
  ],
