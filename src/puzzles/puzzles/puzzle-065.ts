...
/**
 * Puzzle #65 — "It Won't Stay Down" (THREE TURNS: UNDYING, and a burn that
 ...
 * for the reason established with #55 — the goal-greedy bot scores the board
 ...
 * anyone stands — the same isolation #57 was reaching for, done by taking the
 ...
 * Tier-0 fate.
 */
export const PUZZLE_065: PuzzleDefinition = {
  id: 'puzzle-065',
  title: 'Puzzle #65 — It Won\'t Stay Down',
