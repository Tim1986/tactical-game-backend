...
/**
 * Puzzle #37 — "Shut the Gate" (BLOCKED PATH, #41's channel on a new axis).
 *
 ...
 *
 * Runs north-south where #41 ran east-west, and swaps who holds the door: there
 ...
 */
export const PUZZLE_037: PuzzleDefinition = {
  id: 'puzzle-037',
  title: 'Puzzle #37 — Shut the Gate',
