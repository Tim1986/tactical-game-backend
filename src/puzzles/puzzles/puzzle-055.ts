...
/**
 * Puzzle #55 — "Slow Fire" (THREE TURNS: a smaller hit that keeps giving).
 *
 ...
 * random-rate fix from #51).
 *
 * Vocabulary 2 (burning ticks on the victim's slot; a special used once).
 * Tier-0 fate.
 */
export const PUZZLE_055: PuzzleDefinition = {
  id: 'puzzle-055',
  title: 'Puzzle #55 — Slow Fire',
