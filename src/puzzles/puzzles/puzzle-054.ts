...
/**
 * Puzzle #54 — "Let the Dog Wait" (THREE TURNS: the order trap again, on a
 * different chassis).
 *
 * ⚠ DELIBERATE NEAR-CLONE of #48, and spaced from it in the rotation — the same
 * licence #31 takes with #16. The skeleton is identical (a healer that must die
 ...
 * order). Tier-0 fate.
 */
export const PUZZLE_054: PuzzleDefinition = {
  id: 'puzzle-054',
  title: 'Puzzle #54 — Let the Dog Wait',
