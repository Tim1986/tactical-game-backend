...
/**
 * Puzzle #63 — "Into the Ring" (THREE TURNS: displacement into an AREA rather
 * than onto a line).
 *
 * A cousin of #52 rather than a clone: there the Warlock's Fear pushed an enemy
 ...
 */
export const PUZZLE_063: PuzzleDefinition = {
  id: 'puzzle-063',
  title: 'Puzzle #63 — Into the Ring',
