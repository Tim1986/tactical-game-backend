...
/**
 * Puzzle #10 — "Carried Through" (FRIENDLY FIRE, #5's channel, area weapon).
 *
 ...
 *
 * The Sorcerer is ROOTED for the reason #5's Ranger was: a line weapon can
 ...
 * tempo puzzles (#47/#29/#39) are the family that needs none of it.
 *
...
export const PUZZLE_010: PuzzleDefinition = {
  id: 'puzzle-010',
  title: 'Puzzle #10 — Carried Through',
