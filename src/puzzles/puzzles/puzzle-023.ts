...
/**
 * Puzzle #23 — "Field Dressing" (TEMPO, #20's channel, longer reach).
 *
 ...
 *
 * Differs from #20 in the shape of the finish rather than the trap: there the
...
export const PUZZLE_023: PuzzleDefinition = {
  id: 'puzzle-023',
  title: 'Puzzle #23 — Field Dressing',
