...
/**
 * Puzzle #15 — "Feed It Something Cheap" (THREE TURNS: the SHIELD channel
 * again, and a DELIBERATE spaced near-clone of #34 — see the licence note with
 * #25. Different chassis, and a different clause of the same rule.)
 *
 * #34 taught that a shield eats the first damaging hit whole. This one adds the
 ...
 *
 * ⚠ THE TRAP IS DIFFERENT FROM #34'S, WHICH IS WHY THIS IS A CLONE AND NOT A
 ...
 */
export const PUZZLE_015: PuzzleDefinition = {
  id: 'puzzle-015',
  title: 'Puzzle #15 — Feed It Something Cheap',
