...
export const RULEBOOK: RuleSection[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      { id: 'ABL-7', text: "A push slides the target in a straight line, tile by tile. A pull drags the target toward the caster tile by tile, preferring diagonal steps but spending two of its pull tiles per diagonal (so a diagonal pull never covers more ground than a straight one), and never landing on the caster. Either slide stops early at the board edge, a removed corner, or an occupied tile." },
  ...
  },
  {
    ...
    rules: [
      ...
      { id: 'PAS-2', text: "Anchor: the unit can never be pushed or pulled, and gains a small amount of maximum health. A negated push or pull is announced as \"Resisted\"." },
