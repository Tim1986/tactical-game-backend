...
const VITALITY = { slug: 'vitality', name: 'Vitality', description: '+8 max health.', stat: 'maxHealth', value: 8 };
const HARDENED = { slug: 'hardened', name: 'Hardened', description: '+2 armor class.', stat: 'armorClass', value: 2 };
const SWIFT = { slug: 'swift', name: 'Swift', description: '+1 movement range.', stat: 'movementRange', value: 1 };
const IMMOVABLE = { slug: 'immovable', name: 'Immovable', description: 'Cannot be pushed or pulled.', passiveFlag: 'immovable' };
const FRONTLINE_PASSIVES = [VITALITY, HARDENED, IMMOVABLE];
const STANDARD_PASSIVES = [VITALITY, HARDENED, SWIFT];
exports.UNIT_DEFS = [
