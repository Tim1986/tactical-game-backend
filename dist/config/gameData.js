...
exports.UNIT_DEFS = exports.ABILITY_DEFS = void 0;
// ---------------------------------------------------------------------------
// Ability definitions
// ---------------------------------------------------------------------------
exports.ABILITY_DEFS = [
    // ── Barbarian ─────────────────────────────────────────────────────────────
    {
        slug: 'strike',
        name: 'Axe',
    ...
    },
    {
        ...
        description: 'Deals 6 unblockable damage to an adjacent enemy and freezes them for 1 turn.',
        targeting_type: 'single',
        range: 1,
        area_radius: 0,
        cooldown_turns: 99,
    ...
    },
    {
        slug: 'shield_bash',
        name: 'Shield Bash',
        description: 'Deals 16 unblockable damage to an adjacent enemy and knocks them 2 tiles back.',
        targeting_type: 'single',
        range: 1,
        area_radius: 0,
        cooldown_turns: 99,
...
const SWIFT = { slug: 'swift', name: 'Swift', description: '+1 movement range.', stat: 'movementRange', value: 1 };
...
const WARDED = { slug: 'warded', name: 'Warded', description: 'Begin the match with a shield that fully negates the first damaging hit against you — its damage and any effect it carries, even an unblockable one — then breaks. Costs 2 maximum health.', passiveFlag: 'warded', stat: 'maxHealth', value: -2 };
const THORNS = { slug: 'thorns', name: 'Thorns', description: 'When an adjacent enemy hits you, they take 3 damage.', passiveFlag: 'thorns' };
...
const OPPORTUNIST = { slug: 'opportunist', name: 'Opportunist', description: '+4 damage against targets suffering any status effect. Ranger deals +5 instead.', passiveFlag: 'opportunist' };
const VENGEFUL = { slug: 'vengeful', name: 'Vengeful', description: '+3 damage while at or below half health. Barbarian deals +4 instead.', passiveFlag: 'vengeful' };
...
const CHANNELER = { slug: 'channeler', name: 'Channeler', description: '+2 damage on your damage-dealing abilities if you did not move this turn. (No effect on abilities that only apply a status, like Ring of Frost.)', passiveFlag: 'channeler' };
// Siphon (Warlock): drain-flavoured sustain.
const SIPHON = { slug: 'siphon', name: 'Siphon', description: 'Heal 1 whenever one of your abilities damages an enemy.', passiveFlag: 'siphon' };
...
const FIGHTER_PASSIVES = [STALWART_1, THORNS, UNDYING_7];
const BARBARIAN_PASSIVES = [VENGEFUL, THORNS, STALWART_0];
...
const ROGUE_PASSIVES = [SWIFT, OPPORTUNIST, VENGEFUL];
const RANGER_PASSIVES = [STALWART_3, THORNS, OPPORTUNIST];
const CLERIC_PASSIVES = [STALWART_3, WARDED, UNDYING_7];
const WIZARD_PASSIVES = [STALWART_4, OPPORTUNIST, CHANNELER];
const SORCERER_PASSIVES = [STALWART_3, OPPORTUNIST, UNDYING_5];
const WARLOCK_PASSIVES = [STALWART_1, OPPORTUNIST, SIPHON];
exports.UNIT_DEFS = [
    ...
    { slug: 'barbarian', name: 'Barbarian', max_health: 55, armor_class: 10, movement_range: 3, abilities: ['strike', 'whirlwind'], passives: [], special_options: ['whirlwind', 'shockwave', 'roar'], passive_options: BARBARIAN_PASSIVES, unlock_level: 1, asset_key: 'unit_barbarian', is_active: true },
