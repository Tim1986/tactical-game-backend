...
exports.ALL_RULES = exports.RULEBOOK = void 0;
exports.RULEBOOK = [
    {
        id: 'BRD',
        title: 'The Board',
    ...
    },
    {
        ...
        rules: [
            ...
            { id: 'DGE-5', text: "A SHIELD negates the next damaging hit completely — the whole hit, not just its damage. Any root, weaken, expose, push or pull that same attack would have applied is prevented with it (so Pinning Shot's root never lands on a shielded target), even from an unblockable hit. The shield is then used up. Against a multi-hit ability it absorbs only the first hit. A purely non-damaging effect passes through — stopping that is not what a shield is for." },
...
exports.ALL_RULES = exports.RULEBOOK.flatMap((s) => s.rules);
